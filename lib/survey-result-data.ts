...
export const seniorPlans = {
  title: "아들 한동찬님이 요금제 추천했어요!",
  description: `📱 시니어를 위한 특별한 요금제
...
🎁 시니어 할인 혜택까지!
나이에 맞는 특별한 혜택을 받아보세요`,
  plans: [
    {
      name: "시니어 LTE 베이직",
      price: 15000,
      features: ["통화 무제한", "데이터 1GB", "시니어 할인 20%"],
      description: "기본적인 통화와 간단한 인터넷 사용",
    },
    {
      name: "시니어 5G 스마트",
      price: 25000,
      features: ["통화 무제한", "데이터 3GB", "시니어 할인 15%", "자녀 결합 할인"],
      description: "자녀와 함께 쓰는 가족 요금제",
    },
    {
      name: "시니어 프리미엄",
      price: 35000,
      features: ["통화 무제한", "데이터 5GB", "시니어 할인 10%", "건강관리 앱 무료"],
      description: "건강관리까지 포함된 프리미엄 요금제",
    },
  ],
  message: "시니어를 위한 특별한 요금제로 더 편리하게 사용해보세요! 👴👵",
};

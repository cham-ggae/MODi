      ...
      <div className="flex justify-center space-x-4 px-4">
        {members.map((member) => (
          <div key={member.id} className="text-center flex-1 max-w-[60px]">
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 overflow-hidden mx-auto ${member.hasWatered ? "bg-blue-100 border-2 border-blue-400" : "bg-gray-100"
                }`}
            >

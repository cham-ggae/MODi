...
import { ArrowLeft, Send, Mic, Volume2, VolumeX, MicOff, Users } from "lucide-react"
...
export default function ChatPage() {
  ...
  const initialBotMessage: Message = {
    id: "bot-1",
    text: familyMode ? "가족 결합 요금제에 대해 무엇이든 물어보세요!" : "어떤 요금제를 찾고 계신가요?",
    isUser: false,
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 max-w-md mx-auto flex flex-col">
      ...
      <div className="p-4 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">가족 결합 집중 모드</span>
          </div>
          <Switch checked={familyMode} onCheckedChange={setFamilyMode} className="data-[state=checked]:bg-green-500" />
        </div>
        {familyMode && (
          <p className="text-xs text-green-600 dark:text-green-400 mt-2">가족 요금제 결합에 특화된 상담을 제공합니다</p>
        )}
      </div>
      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-auto pb-32">
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mt-2">
                <p className={`text-xs ${msg.isUser ? "text-green-100" : "text-gray-500 dark:text-gray-400"}`}>
                  {msg.timestamp}
                </p>
        ...
        {showInitialButtons && (
          ...
          >
            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">추천 메뉴</h3>

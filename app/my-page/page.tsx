...
import { User, Settings, Bell, HelpCircle, ChevronRight, Calendar, TrendingUp, FileText } from "lucide-react"
...
export default function MyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 max-w-md mx-auto pb-20">
      {/* Header */}
      <div className="bg-white dark:bg-gray-800 px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
      ...
      <div className="p-6 space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{userInfo.name}</h2>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">{userInfo.lastSurveyDate}</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="bg-white dark:bg-gray-800 shadow-sm border-0">
            <CardContent className="p-6 text-center">
              <div className="text-3xl font-bold text-green-500 mb-2">{userInfo.completedMissions}</div>
              <div className="text-gray-600 dark:text-gray-400 text-sm">완료한 미션</div>
            </CardContent>
          </Card>
          <Card className="bg-white dark:bg-gray-800 shadow-sm border-0">
            <CardContent className="p-6 text-center">
              <div className="text-3xl font-bold text-green-500 mb-2">{userInfo.familyMembers}</div>
        ...
        <Card className="bg-white dark:bg-gray-800 shadow-sm border-0">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">지난 요금제 추천 기록</h3>
        ...
        <Card className="bg-gradient-to-r from-green-500 to-blue-500 shadow-sm border-0">
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <Link href="/survey">
                <Button className="bg-white text-green-600 hover:bg-gray-100 font-semibold">성향 검사 시작하기</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">알림, 개인정보 설정</div>
                  </div>
                </div>
        ...
        <Card className="bg-white dark:bg-gray-800 shadow-sm border-0">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">모디 (MODI)</h3>
